/* ===========================================================
   ...
   This is the v2.0 prototype `app.js`. The production runtime
   ships `../app.js` (loaded as `<script src="app.js?v=NN">`
   from `index.html`). Kept here only as a historical
   reference for the old continuous-listening logic; do NOT
   modify or import from this file.
=========================================================== */
/* =========================
