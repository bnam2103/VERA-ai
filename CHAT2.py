...
class VeraAI:
    ...
    def route_action(self, user_text: str, pending_action: dict | None = None, recent_action: dict | None = None) -> dict:
        router_prompt = (
            ...
            "- music.close_panel\n"
            "- general\n\n"
            "Music controls are routed here. Return music.pause, music.resume, music.volume_up, music.volume_down, and music.close_panel when requested.\n"
            ...
            "{"
            "\"domain\":\"weather|news|finance|time|date|music|general\","
            "\"is_action_request\":true,"
            "\"action_name\":\"weather.current|weather.followup|news.latest|finance.quote|finance.context|time.current|date.current|date.delta|music.open_panel|music.play_track|music.play_album|music.play_playlist|music.pause|music.resume|music.volume_up|music.volume_down|music.close_panel|general\","
            "\"slots\":{},"
